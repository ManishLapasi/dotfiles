...
-- Font configuration
config.font_dirs = { 'C:\\Users\\manis\\AppData\\Local\\fonts' }
...
config.keys = {
    ...
    { key = "1", mods = "ALT", action = wezterm.action.ActivateTabRelative(-1) },
    { key = "2", mods = "ALT", action = wezterm.action.ActivateTabRelative(1) },
}
